...
class ActiveRecord_Relation
  ...
  type :includes, "(*Symbol or Hash<Symbol, x>, Hash<Symbol, x> ) -> ActiveRecord_Relation<t>", wrap: false
  ...
  type :+ , "(ActiveRecord_Relation<t>) -> ActiveRecord_Relation<t>", wrap: false
  type :group, "(Symbol or String) -> self", wrap: false
  type :where, "(String, Hash<Symbol, x>) -> self", wrap: false
  type :where, "(String, *%any) -> self", wrap: false
  type :where, "(Hash<Symbol, x>) -> self", wrap: false
  type :where, "() -> self", wrap: false
  type :take, "(Integer) -> ActiveRecord_Relation<t>", wrap: false
  ...
  type :exists?, '(?Hash<Symbol, x>) -> %bool', wrap: false
  type :select, '(*String or Array<String>) -> ActiveRecord_Relation<t>', wrap: false
  type :joins, '(*Symbol) -> ActiveRecord_Relation<t>', wrap: false
  type :create, '(Hash<k, v>) -> t', wrap: false
  type :create!, '(Hash<k, v>) -> t', wrap: false
  type :delete_all, '() -> Integer', wrap: false
  type :sum, '(Symbol) -> Integer', wrap: false
end

class ActiveRecord::Base
  extend RDL::Annotate
  type 'self.where', "(Hash<Symbol, x>) -> ActiveRecord_Relation<self>", wrap: false
  type 'self.where', "(*String) -> ActiveRecord_Relation<self>", wrap: false
  #type 'self.find', "(Integer) -> self", wrap: false
  #type 'self.find', "(Array<Integer>) -> Array<self>", wrap: false
  type 'self.find_by', "(Hash<Symbol, x>) -> self", wrap: false
  ...
  type 'self.includes', "(*Symbol) -> ActiveRecord_Relation<self>", wrap: false
  type 'self.includes', "(*Symbol, Hash<Symbol, x> ) -> ActiveRecord_Relation<self>", wrap: false
  ...
  type 'self.exists?', '(Hash<Symbol, x>) -> %bool', wrap: false
  type 'self.joins', '(*Symbol) -> ActiveRecord_Relation<self>', wrap: false
  type :update!, '(Hash<Symbol, x>) -> %bool', wrap: false
  type 'self.with_deleted', '() -> ActiveRecord_Relation<self>', wrap: false
  type 'self.create', '(Hash<k, v>) -> self', wrap: false
  type :update_column, '(Symbol, %any) -> %bool', wrap: false
end
...
MODELS.each { |model|
  ...
  RDL.type model, 'self.where', "(*String) -> ActiveRecord_Relation<#{model}>", wrap: false
